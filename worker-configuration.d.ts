/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 151bc9b08fa29115ee78b9f586a35149)
// Runtime types generated with workerd@1.20260828.1 2026-08-30 nodejs_compat
interface __BaseEnv_Env {
  INVOICE_RATE_LIMITER: RateLimit;
  SETTLEMENT_RATE_LIMITER: RateLimit;
  INVOICE_BATCHES: DurableObjectNamespace<
    import("./worker/index").InvoiceBatchCoordinator
  >;
}
declare namespace Cloudflare {
  interface GlobalProps {
    mainModule: typeof import("./worker/index");
    durableNamespaces: "InvoiceBatchCoordinator";
  }
